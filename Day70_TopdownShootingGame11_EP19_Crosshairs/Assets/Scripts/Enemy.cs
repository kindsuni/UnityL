...
public class Enemy : LivingEntity {
	...
	{
        AudioManger.instance.PlaySound("Impact", transform.position);
		if (damage >= health) {
            AudioManger.instance.PlaySound("Enemy Death", transform.position);
	...
	IEnumerator Attack() {
		...
		while (percent <= 1) {
            ...
            AudioManger.instance.PlaySound("Enemy Attack", transform.position);
			yield return null;
		}
